...
from aabb_data import read_aabbs_csv
...
class VolumetricDatasetFilepaths:
    ...
    SMPL_FILE = "smpl.tar.gz"
    SMPLX_FILE = "smplx.tar.gz"
    ...
    def __init__(self, data_folder: Path) -> None:
        ...
        self.smpl_path: Path = data_folder.parent / VolumetricDatasetFilepaths.SMPL_FILE
        self.smplx_path: Path = data_folder.parent / VolumetricDatasetFilepaths.SMPLX_FILE
        self.scene_path: Path = data_folder.parent / VolumetricDatasetFilepaths.SCENE_FILE
