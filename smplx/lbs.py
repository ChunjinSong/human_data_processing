...
def lbs(
    ...
    return verts, J_transformed, transforms, J
...
def batch_rigid_transform(
    ...
    # import trimesh
    # path = '/ubc/cs/home/c/chunjins/chunjin_scratch/project/joint.ply'
    # pcd = trimesh.PointCloud(joints[0, :, :, 0].cpu().numpy())
    # pcd.export(path)
    ...
    transforms_mat = transforms_mat.type(torch.float64)
    ...
    transforms = transforms.type(torch.float32)
