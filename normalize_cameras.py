...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_cameras_file', type=str, default=f"data/sequence_name/cameras.npz",
                        help='the input cameras file')
    parser.add_argument('--output_cameras_file', type=str, default=f"data/sequence_name/cameras_normalize.npz",
